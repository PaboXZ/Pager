<?php
	...
	try
	{
		...
		if(!$db_connection->query("INSERT INTO user_data (user_name, user_password, user_email) VALUES ('{$db_result['not_confirmed_name']}', '{$db_result['not_confirmed_password']}', '{$db_result['not_confirmed_email']}')"))
		{
